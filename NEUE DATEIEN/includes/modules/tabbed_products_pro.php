...
if ($proddata != "") {
    ...
    $tabstrip='';
		...
		if (count($CstmTags) >= 1 || count($ZenTags) >= 1 ) {
			...
			if (isset($bCustom1_Tab) && $bCustom1_Tab != false) {
			...
			if (isset($bCustom2_Tab) && $bCustom2_Tab != false) {
			...
			if (isset($bCustom3_Tab) && $bCustom3_Tab != false) {
	    ...
	    $fmtRVW='';
            ...
            if ($bReviews_Tab != false) {
    			...
    			ob_end_clean();
    			$fmtRVW = str_replace('id="productMainImage"', 'id="productMainImageReviewHide" style="display:none;"', $fmtRVW);
